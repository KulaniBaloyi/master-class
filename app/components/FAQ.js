...
const FAQ = () => {
  ...
  <path fillRule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clipRule="evenodd" />
    ...
    {/**============================================ */}
    <ul className="flex flex-col gap-2 my-5 lg:max-w-[60%] mx-auto mb-10">
        <h2 className="opacity-80 font-semibold">Pricing and Payment</h2>
        <li className="border px-2 py-3 rounded-md w-full bg-[#9ea0a9] text-white flex justify-between items-center">
            <p>What is masterclass?</p>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
  <path fillRule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clipRule="evenodd" />
  ...
  <path fillRule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clipRule="evenodd" />
    ...
    {/**============================================== */}
    <ul className="flex flex-col gap-2 my-5 lg:max-w-[60%] mx-auto">
        <h2 className="opacity-80 font-semibold">Sessions</h2>
